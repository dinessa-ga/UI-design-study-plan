...
**Objetivo:** Hacer tangible para testear

**A) Niveles de Fidelidad**

```
PAPER PROTOTYPE
Tiempo: 30 min
Cuándo: Validar flujo básico
✓ Rapidísimo
✗ No interacción real

WIREFRAME
Tiempo: 2-4 horas
Cuándo: Validar layout e IA
✓ Clarifica estructura
✗ No valida visual

MOCKUP
Tiempo: 1-2 días
Cuándo: Validar diseño visual
✓ Realista
✗ Toma más tiempo

PROTOTIPO INTERACTIVO
Tiempo: 3-5 días
Cuándo: Validar interacciones
✓ Experiencia real
✗ Requiere esfuerzo
```
...
```
PROYECTO: To-Do List (3 pantallas)

PASO 1: Crear frames (5 min)
- "01 - Home"
- "02 - Add Task"
- "03 - Task Detail"

PASO 2: Diseñar Home (15 min)
├── Status Bar
├──